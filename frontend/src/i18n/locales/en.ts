export default {
  ...
  admin: {
    ...
    settings: {
      ...
      apiStation: {
        fingerprintBilling: {
          title: 'API Station — Fingerprint & Billing',
          description: 'Claude Code fingerprint algorithm and billing header configuration',
          billingEntrypoint: 'Billing Entrypoint',
          billingEntrypointHint: 'Value for cc_entrypoint field in billing header',
          billingEntrypointPlaceholder: 'cli',
          fingerprintSalt: 'Fingerprint Salt',
          fingerprintSaltHint: 'SHA256 salt for message fingerprint calculation',
          fingerprintSaltPlaceholder: '59cf53e54c78',
          cliVersion: 'CLI Version Override',
          cliVersionHint: 'Override cc_version in billing header. Leave empty for auto-detection.',
          cliVersionPlaceholder: '1.0.33',
          latestKnownCliVersion: 'Latest Known CLI Version',
          latestKnownCliVersionHint: 'Auto-detected by version drift monitor. Can be set manually.',
          latestKnownCliVersionPlaceholder: 'auto-detected',
        },
        sessionCooldown: {
          title: 'API Station — Session & Cooldown',
          description: 'Session ID masking TTL and tiered cooldown configuration',
          sessionTtlMin: 'Session TTL Min (minutes)',
          sessionTtlMinHint: 'Minimum TTL for masked session IDs',
          sessionTtlMax: 'Session TTL Max (minutes)',
        ...
        betaHeaders: {
          title: 'API Station — Beta Headers',
          description: 'anthropic-beta header values per account type and model. Leave empty for built-in defaults.',
          oauth: 'OAuth (non-Haiku)',
          oauthHint: 'Comma-separated beta flags for OAuth non-Haiku models',
          oauthHaiku: 'OAuth (Haiku)',
          oauthHaikuHint: 'Comma-separated beta flags for OAuth Haiku models',
          apikey: 'API Key (non-Haiku)',
          apikeyHint: 'Comma-separated beta flags for API Key non-Haiku models',
          apikeyHaiku: 'API Key (Haiku)',
          apikeyHaikuHint: 'Comma-separated beta flags for API Key Haiku models',
        },
        monitoring: {
          title: 'API Station — Monitoring & Sensitive Words',
          description: 'Alert configuration, sensitive word obfuscation, and monitoring intervals',
          sensitiveWordsEnabled: 'Sensitive Words Obfuscation',
          sensitiveWordsEnabledHint: 'Insert zero-width characters into sensitive words before forwarding',
          sensitiveWordsList: 'Sensitive Words List (JSON)',
          sensitiveWordsListHint: 'JSON array of words to obfuscate. Leave empty for built-in defaults.',
          sensitiveWordsListPlaceholder: '["word1", "word2"]',
          feishuWebhookUrl: 'Feishu Webhook URL',
          feishuWebhookUrlHint: 'Webhook URL for ban alerts and version drift notifications',
          feishuWebhookUrlPlaceholder: 'https://open.feishu.cn/open-apis/bot/v2/hook/xxx',
          monitorCheckInterval: 'Monitor Check Interval (seconds)',
          monitorCheckIntervalHint: 'How often the background monitor runs checks',
          banAlertThreshold: 'Ban Alert Threshold',
          banAlertThresholdHint: 'Consecutive 401/403 failures before triggering a ban alert',
        },
      },
      site: {
        title: 'Site Settings',
